 ...
 * @memberof DataChannelsManager
 * @type Object
 * @property {(DataMessage[]|null)} messages - The messages list, may be null.
 ...
 * @memberof DataChannelsManager
 * @type Object
 * @property {(DataChannel|null)} dataChannel - The Data channel, may be null.
 ...
 *
 * @class
 * @property {DataChannel[]} channelsList - Channels list
 */
class DataChannelsManager {
	 ...
	 * @param {Message[]} msgList - Message list
	 * @returns {DataChannelsManager.SearchResult_ByTypeExtra}
	 */
	 ...
	 * 
	 * @param {string} dchID - Data channel ID
	 * @returns {DataChannelsManager.SearchResult_ByID}
	 */
